...
\author{Primož~Bajželj, Fakulteta za računalništvo in informatiko, 2012 % <-this % stops a space
%\author{Primož~Bajželj,~\IEEEmembership{Member,~IEEE,}
...
\begin{abstract}
%\boldmath
Včasih nas nostalgija lahko ponese nekaj let ali celo desetletje v preteklost. Chiptune je
glasba, ki se je pojavila več kot desetletje v preteklosti in sega celo v prejšnje tisočletje.
V nadaljevanju je predstavljen le del, ki je bil razvit in predstavlja tokovnik za prenos
že ustvarjene glasbe.
\end{abstract}
% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
Tokovnik, chiptune, splet
\end{IEEEkeywords}

\selectlanguage{english}
\begin{abstract}
%\boldmath
Nostalgy can sometimes take us few years or even a decade into the past. Chiptune is
an example of music, which appeared more than decade ago and reaches even into
the previous millennium. In this paper streamer is presented which is part
...
\IEEEPARstart{S}{treamanje} je način prenosa pri katerem končni uporabnik lahko neprestano dostopa do določenega vira katerega nek ponudnik ponuja. Pri tem velja, da se lahko sam prikaz začne še preden je prenesen celoten vir - torej predvajanje filma se lahko začne še predno imamo cel film na računalniku. Primeri različnih streamanj pa so npr. radio, televizija ali cene delnic.
...
%\bibitem{IEEEhowto:prosojnice}
%Trček Denis., \emph{Računalniška zvočna produkcija, kopije prosojnic}, FRI UL, Ljubljana 2011
